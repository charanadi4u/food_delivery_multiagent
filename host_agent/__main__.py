...
async def main():
    ...
    with gr.Blocks(
         title='Food Delivery Host Agent with Logo'
    ) as demo:
        gr.Image(
        ...
        gr.ChatInterface(
            ...
            title='Food Delivery Host Agent',
            description='This assistant can help you plan and track food delivery orders using multiple agents',
        )
